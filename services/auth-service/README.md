...
<div align="center">
  ...
  <p align="center">
    ...
    .
    <a href="http://localhost:14361/api-docs/swagger-ui/">OpenAPI UI</a>
  </p>
</div>
...
```
  docker run --name postgresdb -e POSTGRES_PASSWORD=<password in application.properties> -e POSTGRES_DB=authservicedb -p 5432:5432 -d postgres:12.6
```
...
```
java -jar build/libs/auth-service-0.1.0.jar
```
