...
<div align="center">
  <h3 align="center">member-service</h3>
  <p align="center">
    Member Service
    <br />
    ...
    .
    <a href="http://localhost:11255/api-docs/swagger-ui/">OpenAPI UI</a>
  </p>
</div>
...
```
  docker run --name postgresdb -e POSTGRES_PASSWORD=<password in application.properties> -e POSTGRES_DB=memberservicedb -p 5432:5432 -d postgres:12.6
```
...
```
java -jar build/libs/member-service-0.1.0.jar
```
