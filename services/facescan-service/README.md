...
<div align="center">
  <h3 align="center">appointment-service</h3>
  <p align="center">
    Appointment Service
    <br />
    ...
    .
    <a href="http://localhost:12516/api-docs/swagger-ui/">OpenAPI UI</a>
  </p>
</div>
...
```
  docker run --name postgresdb -e POSTGRES_PASSWORD=<password in application.properties> -e POSTGRES_DB=appointmentservicedb -p 5432:5432 -d postgres:12.6
```
...
```
java -jar build/libs/appointment-service-0.1.0.jar
```
