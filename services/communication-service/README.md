...
<div align="center">
  <h3 align="center">communication-service</h3>
  <p align="center">
    ...
    .
    <a href="http://localhost:11151/api-docs/swagger-ui/">OpenAPI UI</a>
  </p>
</div>
...
```
  docker run --name postgresdb -e POSTGRES_PASSWORD=<password in application.properties> -e POSTGRES_DB=communicationservicedb -p 5432:5432 -d postgres:12.6
```
...
```
java -jar build/libs/communication-service-0.1.0.jar
```
