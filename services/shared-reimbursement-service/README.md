...
<div align="center">
  <h3 align="center">claims-service</h3>
  <p align="center">
    Claims Service
    <br />
    ...
    .
    <a href="http://localhost:10087/api-docs/swagger-ui/">OpenAPI UI</a>
  </p>
</div>
...
```
  docker run --name postgresdb -e POSTGRES_PASSWORD=<password in application.properties> -e POSTGRES_DB=claimsservicedb -p 5432:5432 -d postgres:12.6
```
...
```
java -jar build/libs/claims-service-0.1.0.jar
```
