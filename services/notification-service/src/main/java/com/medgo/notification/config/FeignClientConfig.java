package com.medgo.notification.config;

import com.medgo.notification.service.AzureKeyVaultService;
import feign.Logger;
...
public class FeignClientConfig {
    ...
    private void loadSecrets() {
        try {
            ...
            System.out.println("***Data***" + basicPassword);
            System.out.println("***Data***" + basicUser);
            System.out.println("***Data***" + apimHeader);
            System.out.println("***Data***" + apimKey);
